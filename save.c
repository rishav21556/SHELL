...
int main(int argc,char *a[3]){
    int fd = open("/mnt/c/Users/Rishav Raj/OneDrive/Desktop/OS_Assignment1/test/totest/rm.out",O_RDONLY);  
    if (fd>0){
    ...
    // strcat(chair,"/rm.out");
    // int check  ;
    // if (strcmp(a[0],chair)==0){
    //     check = 1;
    // }
    // else{
    //     check = 0;
    // }
    // if (strcmp(a[check],"-d")==0 || strcmp(a[check+1],"-d")==0){
    //     int i;
    //     if (strcmp(a[check+1],"-d")==0 && strcmp(a[check],"-i")==0){
    //         i = 2;
    //     }
    //     else if (strcmp(a[0],"-d")==0 && strcmp(a[1],"-d")==0){
